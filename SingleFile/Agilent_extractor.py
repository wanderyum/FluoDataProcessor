import os
import sys
from misc import get_file_names, agilent_extract_data_from_single_file, combine_dictionaries, save_by_channel
...
class data_extractor():
    ...
    def extract(self, folder):
        ...
        D = agilent_extract_data_from_single_file(os.path.join(folder, files[0]))
        for f in files[1:]:
            D = combine_dictionaries(D, agilent_extract_data_from_single_file(os.path.join(folder,f)))
